...
(function() {
  const quizData = [
    ...
    },
    {
      ...
      "answers": ["Armazenar dados permanentemente", "Armazenar dados temporariamente em uso", "Realizar processamento gráfico"],
      "correct": 1,
      "explanation": "A memória RAM armazena dados temporariamente enquanto o computador está em uso."
    },
    {
      "category": "Hardware",
      "question": "O que é um disco rígido (HDD)?",
      "answers": ["Um tipo de memória volátil", "Um dispositivo de armazenamento permanente", "Um processador gráfico"],
      "correct": 1,
      "explanation": "O HDD (Disco Rígido) é um dispositivo de armazenamento que usa discos magnéticos para armazenar dados."
    },
    {
      "category": "Hardware",
      "question": "Qual é a função de uma placa-mãe?",
      "answers": ["Armazenar informações", "Interconectar os componentes do computador", "Controlar a velocidade do processador"],
      "correct": 1,
      "explanation": "A placa-mãe conecta todos os componentes do computador e permite a comunicação entre eles."
    },
    {
      "category": "Hardware",
      "question": "Qual é a diferença entre um SSD e um HDD?",
      "answers": ["SSD é mais lento que HDD", "HDD usa memória flash, enquanto SSD usa discos magnéticos", "SSD é mais rápido e não tem partes móveis, enquanto HDD tem"],
      "correct": 2,
      "explanation": "Um SSD (Solid State Drive) é mais rápido e não possui partes móveis, ao contrário de um HDD (Disco Rígido), que utiliza discos magnéticos."
    },
    {
      "category": "Hardware",
      "question": "Qual é a função de uma fonte de alimentação?",
      "answers": ["Armazenar dados", "Converter a corrente elétrica e fornecer energia para os componentes", "Realizar o processamento de dados"],
      "correct": 1,
      "explanation": "A fonte de alimentação converte a corrente elétrica da tomada e fornece energia para os componentes do computador."
    },
    {
      "category": "Hardware",
      "question": "O que faz uma placa de vídeo?",
      "answers": ["Armazena dados", "Renderiza gráficos e imagens", "Controla o sistema operacional"],
      "correct": 1,
      "explanation": "A placa de vídeo (GPU) é responsável por renderizar gráficos e imagens, melhorando a qualidade visual."
    },
    {
      "category": "Hardware",
      "question": "Qual é a função de um cooler em um computador?",
      "answers": ["Armazenar dados", "Resfriar os componentes para evitar superaquecimento", "Aumentar a velocidade do processador"],
      "correct": 1,
      "explanation": "Um cooler resfria os componentes do computador, evitando superaquecimento durante o uso intenso."
    },
    {
      "category": "Hardware",
  ...
  function selectAnswer(selectedIndex) {
    ...
    if (selectedIndex === correctAnswerIndex) {
      buttons[selectedIndex].classList.remove("bg-gray-700", "hover:bg-gray-600");
